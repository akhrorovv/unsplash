...
//
//     final collectionsPhoto = collectionsPhotoFromJson(jsonString);

import 'dart:convert';

List<CollectionsPhoto> collectionsPhotoFromJson(String str) => List<CollectionsPhoto>.from(json.decode(str).map((x) => CollectionsPhoto.fromJson(x)));

String collectionsPhotoToJson(List<CollectionsPhoto> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class CollectionsPhoto {
  String id;
  // String slug;
  ...
  factory CollectionsPhoto.fromJson(Map<String, dynamic> json) => CollectionsPhoto(
    id: json["id"],
    // slug: json["slug"],
    ...
    // links: CollectionsPhotoLinks.fromJson(json["links"]),
    // likes: json["likes"],
...
class CollectionsPhotoLinks {
  String self;
  String html;
  String download;
  String downloadLocation;

  CollectionsPhotoLinks({
    required this.self,
    required this.html,
  ...
  factory CollectionsPhotoLinks.fromJson(Map<String, dynamic> json) => CollectionsPhotoLinks(
    self: json["self"],
    html: json["html"],
...
class TopicSubmissions {
  ...
  factory TopicSubmissions.fromJson(Map<String, dynamic> json) => TopicSubmissions(
    ...
    workFromHome: json["work-from-home"] == null ? null : BusinessWork.fromJson(json["work-from-home"]),
  );
...
class User {
  ...
  factory User.fromJson(Map<String, dynamic> json) => User(
    ...
    instagramUsername: instagramUsernameValues.map[json["instagram_username"]]!,
  ...
  Map<String, dynamic> toJson() => {
    ...
    "instagram_username": instagramUsernameValues.reverse[instagramUsername],
...
final idValues = EnumValues({
  "pXhwzz1JtQU": Id.P_XHWZZ1_JT_QU
});

enum InstagramUsername {
  ALEJANDROESCAMILLA_PHOTOGRAPHY
}

final instagramUsernameValues = EnumValues({
  "alejandroescamilla_photography": InstagramUsername.ALEJANDROESCAMILLA_PHOTOGRAPHY
});
...
final nameValues = EnumValues({
  "Alejandro Escamilla": Name.ALEJANDRO_ESCAMILLA
});
...
final usernameValues = EnumValues({
  "alejandroescamilla": Username.ALEJANDROESCAMILLA
});
